...
public class BrineFluidType extends FluidType {
    public static final ResourceLocation FLUID_STILL = ResourceLocation.fromNamespaceAndPath(ProximaVis.MOD_ID, "block/brine_still");
    public static final ResourceLocation FLUID_FLOWING = ResourceLocation.fromNamespaceAndPath(ProximaVis.MOD_ID, "block/brine_flowing");
    public static final ResourceLocation OVERLAY = ResourceLocation.fromNamespaceAndPath(ProximaVis.MOD_ID, "misc/under_brine");
